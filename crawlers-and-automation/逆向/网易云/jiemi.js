      ...
      , q = l.BufferedBlockAlgorithm = t.extend({
        ...
        mV4Z: function(a) {
            var c = this.i1x
              ...
              , k = this.blockSize
              , b = j / (4 * k)
              , b = a ? u.ceil(b) : u.max((b | 0) - this.WD3x, 0);
            a = b * k;
            j = u.min(4 * a, j);
            if (a) {
                for (var q = 0; q < a; q += k)
    ...
    var p = CryptoJS
      ...
      , v = d.Cipher = t.extend({
        ...
        createEncryptor: function(e, a) {
            return this.create(this.HO1x, e, a)
        },
        createDecryptor: function(e, a) {
            return this.create(this.bpG8y, e, a)
        },
        init: function(e, a, b) {
...
(function() {
    ...
    var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
      , d = d.AES = p.extend({
        mD4H: function() {
            for (var a = this.J2x, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.bbV4Z = d + 6) + 1), e = this.bpC8u = [], j = 0; j < a; j++)
                if (j < d)
                    e[j] = c[j];
                else {
                    var k = e[j - 1];
        ...
        encryptBlock: function(a, b) {
            this.Df8X(a, b, this.bpC8u, t, r, w, v, l)
        },
        decryptBlock: function(a, c) {
            var d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d;
            this.Df8X(a, c, this.bpB7u, b, x, q, n, s);
            d = a[c + 1];
            a[c + 1] = a[c + 3];
            a[c + 3] = d
        },
        Df8X: function(a, b, c, d, e, j, l, f) {
            for (var m = this.bbV4Z, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
function getSigh(i1x) {
    e = '010001'
    f = ''
    g = '0CoJUm6Qyw8W8jud'
    bYD8v = asrsea(JSON.stringify(i1x), e, f, g);
    return bYD8v
}
i1x = {
    "ids": "[1815725297]",
